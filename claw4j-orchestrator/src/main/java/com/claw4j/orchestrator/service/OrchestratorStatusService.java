...
/**
 * Builds defensive Orchestrator identity responses for internal service calls.
 */
@Service
public class OrchestratorStatusService {
    ...
    /**
     * Returns Orchestrator identity after validating required internal call context.
     *
