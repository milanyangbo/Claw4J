...
Service modules SHALL be allowed to depend on `claw4j-common`, and SHALL NOT introduce direct Maven dependencies on sibling service modules in the initial skeleton.
